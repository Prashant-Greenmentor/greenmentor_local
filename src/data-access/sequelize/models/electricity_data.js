...
module.exports = (sequelize, DataTypes) => {
  class electricity_data extends Model {
    /**
    ...
    static associate(models) {
      ...
      models.electricity_data.belongsTo(models.site_master, {
        foreignKey: "site_id",
      });
      models.electricity_data.belongsTo(models.electricity_source, {
        foreignKey: "electricity_source_id",
      });
      models.electricity_data.belongsTo(models.unit_master, {
        foreignKey: "unit_id",
      });
      models.electricity_data.belongsTo(models.currency_master, {
        foreignKey: "currency_id",
      });
      models.electricity_data.belongsTo(models.organization, {
        foreignKey: "organization_id",
      });
      models.electricity_data.belongsTo(models.user, {
        foreignKey: "modified_by",
      });
      models.electricity_data.belongsTo(models.ModuleMaster, {
        foreignKey: "module_id",
      });
      models.electricity_data.belongsTo(models.SubModuleMaster, {
        foreignKey: "sub_module_id",
      });
    }
  }
  electricity_data.init(
    {
      ...
      consumed_value: DataTypes.DECIMAL,
